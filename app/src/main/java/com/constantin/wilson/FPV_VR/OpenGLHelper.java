...
public class OpenGLHelper {
    ...
    public static void makeOverlayUnit(float[] array,int arrayOffset,float[] array2,int arrayOffset2,
                                       float x,float y,float z,float height,float width,float xOff,float offset,boolean zero){
        if(zero){
            makeRectangle4(array,arrayOffset+0*18,array2 ,arrayOffset2+0*12,x+(0*width/6) ,y ,z ,height,width/6,0,0);
            makeRectangle4(array,arrayOffset+1*18,array2 ,arrayOffset2+1*12,x+(1*width/6) ,y ,z ,height,width/6,0,0);
            makeRectangle4(array,arrayOffset+2*18,array2 ,arrayOffset2+2*12,x+(2*width/6) ,y ,z ,height,width/6,0,0);
            makeRectangle4(array,arrayOffset+3*18,array2 ,arrayOffset2+3*12,x+(3*width/6) ,y ,z ,height,width/6,xOff,offset);
            makeRectangle4(array,arrayOffset+4*18,array2 ,arrayOffset2+4*12,x+(4*width/6) ,y ,z ,height,width/6,xOff+(offset*1),offset);
            makeRectangle4(array,arrayOffset+5*18,array2 ,arrayOffset2+5*12,x+(5*width/6) ,y ,z ,height,width/6,xOff+(offset*2),offset);
        }else{
